...
gem "ahoy_email", "~> 1.1", ">= 1.1.0" # Email analytics for Rails
...
gem "doorkeeper", "~> 5.4", ">= 5.4.0" # Oauth 2 provider
...
gem "feedjira", "~> 3.1", ">= 3.1.1" # A feed fetching and parsing library
gem "field_test", "~> 0.3", ">= 0.3.2" # A/B testing
...
gem "fog-aws", "~> 3.6", ">= 3.6.5" # 'fog' gem to support Amazon Web Services
...
gem "html_truncator", "~> 0.4", ">= 0.4.2" # Truncate an HTML string properly
...
gem "inline_svg", "~> 1.7", ">= 1.7.1" # Embed SVG documents in your Rails views and style them with CSS
...
gem "kaminari", "~> 1.2", ">= 1.2.1" # A Scope & Engine based, clean, powerful, customizable and sophisticated paginator
...
gem "nokogiri", "~> 1.11", ">= 1.11.0" # HTML, XML, SAX, and Reader parser
...
gem "rails", "~> 6.0.3", ">= 6.0.3.2" # Ruby on Rails
...
gem "reverse_markdown", "~> 2.0", ">= 2.0.0" # Map simple html back into markdown
...
gem "twilio-ruby", "~> 5.37", ">= 5.37.0" # The official library for communicating with the Twilio REST API
...
group :development do
  ...
  gem "web-console", "~> 4.0", ">= 4.0.3" # Rails Console on the Browser
...
group :development, :test do
  ...
  gem "capybara", "~> 3.32", ">= 3.32.2" # Capybara is an integration testing tool for rack based web applications
  ...
  gem "rspec-rails", "~> 4.0", ">= 4.0.1" # rspec-rails is a testing framework for Rails 3+
...
group :test do
  gem "approvals", "~> 0.0", ">= 0.0.24" # A library to make it easier to do golden-master style testing in Ruby
  gem "database_cleaner-active_record", "~> 1.8.0"
  gem "exifr", ">= 1.3.6" # EXIF Reader is a module to read EXIF from JPEG and TIFF images
  gem "factory_bot_rails", "~> 6.0", ">= 6.0.0" # factory_bot is a fixtures replacement with a straightforward definition syntax, support for multiple build strategies
  ...
  gem "pundit-matchers", "~> 1.6", ">= 1.6.0" # A set of RSpec matchers for testing Pundit authorisation policies
  ...
  gem "webdrivers", "~> 4.4", ">= 4.4.1" # Run Selenium tests more easily with install and updates for all supported webdrivers
